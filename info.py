...
PICS = (environ.get('PICS', 'https://i.ibb.co/c0jpVQW/image.jpg' 'https://i.ibb.co/nM9fNZQb/image.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002778536245') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002778536245')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviecenter_junction')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mcserieshub') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/dudetg')
